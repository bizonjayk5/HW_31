...
import static org.junit.Assert.*; import org.junit.*; import org.junit.runners.MethodSorters;
...
public class CalculatorTest2 {
      ...
      @Test(timeout=1000) // @Ignore
       ...
       public void test_10_subtract_2() {System.out.println("Test # 10: Subtract 2 params");

              assertEquals("Not correct", Calculator.subtract(28.0, 14.0), 14.0, 0.09);}

       @Test(timeout=1000) // @Ignore

       public void test_11_subtract_3() {System.out.println("Test # 11: Subtract 3 params");

              assertEquals("Not correct", Calculator.subtract(220.0, 20.0, 120.0), 80.0, 0.09);}

       @Test(timeout=1000) // @Ignore

       public void test_12_subtract_4() {System.out.println("Test # 12: Subtract 4 params");
